            ...
            if st.button("Train GRU-PSO"):
                ...
                with st.spinner("Training Model..."):
                    ...
                    with col2:
                        ...
                        plt.title('Model GRU-PSO: Aktual vs Prediksi Harga Emas Indonesia (IDR/Gram)', fontsize=12)
                        plt.xlabel('Indeks Waktu (Data Testing)', fontsize=10)
                        plt.ylabel('Harga Emas (Rp)',             fontsize=10)
                        plt.legend()
            ...
            if st.button("Train GRU Standar"):
                ...
                with st.spinner("Training GRU Standar..."):
                    ...
                    with col2:
                        ...
                        plt.title('Model GRU Standar: Aktual vs Prediksi Harga Emas Indonesia (IDR/Gram)', fontsize=12)
                        plt.xlabel('Indeks Waktu (Data Testing)', fontsize=10)
                        plt.ylabel('Harga Emas (Rp)',             fontsize=10)
                        plt.legend()
                        plt.grid(True, alpha=0.2)
        ...
        with st.container(border=True):
            ...
            if res_pso is None and res_gs is None:
                ...
                with col2:
                    ...
                    ax.set_title('Perbandingan Aktual vs Prediksi: GRU-PSO & GRU Standar', fontsize=12)
                    ax.set_xlabel('Indeks Waktu (Data Testing)', fontsize=9)
                    ax.set_ylabel('Harga Emas (Rp)', fontsize=9)
                    ax.legend()
